...
public class FinanceProgressView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(mProgressRect, START_ANGLE, progress * MAX_ANGLE / MAX_PROGRESS, false, mCirclePaint);
        drawText(canvas);
    ...
    private void drawText(Canvas canvas) {
        final String progressString = formatString(progress);
    ...
    private void extractAttributes(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        try {
            progress = typedArray.getInteger(R.styleable.FinanceProgressView_progress, 0);
            ...
            Log.d(TAG, "Progress = " + progress + ", " + "Color = " + mColor + ", textSize = " + mTextSize + ", strokeWidth = " + mStrokeWidth);
        } finally {
            typedArray.recycle();
        }
    }
